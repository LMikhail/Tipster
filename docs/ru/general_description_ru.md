...
**Tipster** — это язык и среда программирования, совмещающие декларативную мощь логических языков (в духе Пролога) с процедурной и функциональной гибкостью Clojure/EDN. Главная особенность Tipster — **единый синтаксис и двойная семантика выражений**:
...
* Такой подход позволяет строить гибкие и выразительные правила, совмещая логику и функционал без дублирования кода, а также использовать всю стандартную библиотеку Clojure как источник “логических фактов” для Tipster.
...
#### 2. Факты: основа логических знаний Tipster
...
#### 3. Правила: построение новых знаний из фактов
